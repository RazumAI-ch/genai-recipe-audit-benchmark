...
import config.keys.keys_llms as config_keys_llms
...
class AbstractEvaluatedLLMBase(InterfaceEvaluatedLLM, ABC):
    ...
    def __init__(self):
        ...
        self.temperature = config_keys_llms.LLM_TEMPERATURE
        self.max_tokens = self.model_config.get("max_tokens", config_keys_llms.LLM_MAX_TOKENS_DEFAULT)
    ...
    def prepare(self, overrides: Dict[str, Any] = None):
        ...
        self.system_prompt = self.prompt_config.get(config_keys_llms.SYSTEM_PROMPT, "")
        self.user_prompt_prefix = self.prompt_config.get(config_keys_llms.USER_PROMPT, "")
        ...
        self.model = self.model_config[config_keys_llms.MODEL]
        self.batch_size = self.model_config.get(config_keys_llms.BATCH_SIZE, config_keys_llms.LLM_DEFAULT_BATCH_SIZE)
